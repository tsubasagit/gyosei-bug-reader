...
(() => {
  ...
  const EN = {
    ...
    'hero.coverAlt': 'Cover of Administrative Error! Tetsu Genda, Rena Akamine, Shota Suzuki and Go Gotokuji.',
    'hero.kicker': 'Standalone chapters · city hall gag manga',
    'hero.logo': 'Administrative Error!',
  ...
  const STR = {
    ...
    en: {
      ...
      shareText: (n, title) => `Read “Administrative Error!” Ep. ${n}: ${title}`,
